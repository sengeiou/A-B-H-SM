...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
        self.labelFont =FontGothamBold(14); //[UIFont boldSystemFontOfSize:kLabelFontSize];
        self.detailsLabelFont = FontGothamMedium(12); //[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
