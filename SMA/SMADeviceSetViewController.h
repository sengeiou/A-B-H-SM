...
@property (nonatomic, weak) IBOutlet UILabel *deviceLab, *antiLostLab, *noDistrubLab, *callLab, *smsLab, *screenLab, *sleepMonLab, *sedentaryLab, *alarmLab, *HRSetLab, *vibrationLab, *backlightLab, *photoLab, *watchLab, *dfuUpdateLab, *unPairLab;
@property (nonatomic, weak) IBOutlet UITableViewCell *deviceCell, *switchCell, *sedentaryCell, *alarmCell, *HRSetCell,*vibrationCell, *backlightCell, *photoCell, *watchChangeCell, *dfuUpdateCell, *unPairCell;
@property (nonatomic, strong) SMAUserInfo *userInfo;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint *deviceLead, *deviceW, *deviceH;
@end
