...
@property (nonatomic, weak) IBOutlet UILabel *deviceLab, *antiLostLab, *noDistrubLab, *callLab, *smsLab, *screenLab, *sleepMonLab, *sedentaryLab, *alarmLab, *HRSetLab, *vibrationLab, *backlightLab, *photoLab, *timingLab, *watchLab, *dfuUpdateLab, *unPairLab, *findDeviceLab;
@property (nonatomic, weak) IBOutlet UITableViewCell *deviceCell, *switchCell, *sedentaryCell, *alarmCell, *HRSetCell,*vibrationCell, *backlightCell, *photoCell, *watchChangeCell, *dfuUpdateCell, *unPairCell, *timingCell, *findDiviceCell;
