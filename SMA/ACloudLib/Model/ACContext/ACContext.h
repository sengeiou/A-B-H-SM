...
@property (nonatomic, copy) NSString *version; // 系统版本
@property (nonatomic, copy) NSString *sdkVersion; //SDK的版本信息
@property (nonatomic, copy) NSString *majorDomain; // 服务所属主域名
...
@property (nonatomic, copy) NSString *timestamp; // 请求发起的时间戳，单位秒
@property (nonatomic, copy) NSString *signature; // 请求的签名
@property (nonatomic, copy) NSString *accessMode;//请求的模式 为1 则为匿名访问
